...
#./bladegps -t `date -u +'%Y/%m/%d,%H:%M:%S'` $* -i -l 36.375278,127.361667,60 #N26
#./bladegps -t `date -u +'%Y/%m/%d,%H:%M:%S'` $* -i -l 37.369444,127.5675,60 #N26
./bladegps -t `date -u +'%Y/%m/%d,%H:%M:%S'` $* -i -l 36.392386,127.392365,60 #N26
